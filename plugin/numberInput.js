jQuery.fn.extend({
  ...
  _initNumDom: function(opt){
    for (var i = 0,len = this.length; i < len; i++) {
      ...
      wrapper.css({"position": "relative", "display": "inline-block", "vertical-align": "top", "height": "40px", "width": "130px", "border": "1px solid #ccc", "box-sizing": "border-box", "overflow": "hidden"})
      console.log
      $(this[i]).append(wrapper);
      var inputN = $('<input type="text" class="'+opt.inputClass+'"/>');
      inputN.css({"height": "40px", "width": "130px", "padding": "6px 0px 0 0px", "font-size": "14px", "line-height": "40px", "background": "#fff", "box-shadow": "inset 0 1px 1px rgba(0,0,0,.075)", "box-sizing": "border-box", "border": "none"})
      var addBtn = $('<span class="'+opt.addClass+'"></span>')
      addBtn.css({"position": "absolute", 'right': 0, 'top': 0, 'width': 25, "height": 20, "border-left": "1px solid #ccc", "box-sizing": "border-box", "cursor": "pointer"})
      var subtractBtn = $('<span class="'+opt.subtractClass+'"></span>')
      subtractBtn.css({"position": "absolute", 'right': 0, 'bottom': 0, 'width': 25, "height": 20, "border-left": "1px solid #ccc", "box-sizing": "border-box", "cursor": "pointer"})
